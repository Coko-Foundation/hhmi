...
role :app, %w{abuilder_static@hhmi.byf1.dev}, :primary => true
role :web, %w{abuilder_static@hhmi.byf1.dev}
role :db,  %w{abuilder_static@hhmi.byf1.dev}
