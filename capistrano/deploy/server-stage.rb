...
role :app, %w{abuilder_node@hhmi.byf1.dev}, :primary => true
role :web, %w{abuilder_node@hhmi.byf1.dev}
role :db,  %w{abuilder_node@hhmi.byf1.dev}
...
Rake::Task["deploy:published"].enhance ["deploy:restart_node_stage"]
